...
export default function ViewUser() {
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                const response = await axios.get('https://de23-2804-d41-b066-6900-789f-f58e-445e-b3a7.ngrok-free.app/userlist');
    ...
    const handleDeleteUser = async (userName) => {
        try {
            ...
            await axios.delete(`https://de23-2804-d41-b066-6900-789f-f58e-445e-b3a7.ngrok-free.app/users/${userName}`);
