  ...
  useEffect(() => {
    const fetchASGQuestions = async () => {
      try {
        ...
        const response = await axios.get(`https://server-checklist.onrender.com/perguntas/1?type=${tipoPergunta}`);
        ...
        if (response.data && Array.isArray(response.data)) {
          ...
          console.error(`Resposta inválida ao buscar perguntas do tipo ${tipoPergunta} para o setor SALAO:`, response.data);
        }
      } catch (error) {
        console.error(`Erro ao buscar perguntas do tipo para o setor SALAO:`, error);
      }
    };
...
<html>
  ...
  <body>
    <div class="logo-container">
      <img class="logo-img" src="https://i.imgur.com/UAoOfkm.png" alt="Logo da empresa" />
    </div>
    <div class="content">
...
sendEmailWithAttachment = async () => {
  try {
    ...
    const subject = 'Relatorio do dia do setor SALAO';
  ...
  return (
    <>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>CHECKLIST SALAO</Text>
      </View>
