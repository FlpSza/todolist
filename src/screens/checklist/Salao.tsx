  ...
  useEffect(() => {
    const fetchASGQuestions = async () => {
      try {
        ...
        const response = await axios.get(`https://21ef-2804-d41-b066-6900-e906-e6be-d145-2d5b.ngrok-free.app/perguntas/1?type=${tipoPergunta}`);
  ...
  return (
    <>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>CHECKLIST SALÃO</Text>
      </View>
